...
#AutoIt3Wrapper_Icon=_files\icon.ico
...
#AutoIt3Wrapper_Res_Fileversion=0.0.10.14
...
#Region ### START Koda GUI section ### Form=
	...
	While 1
		...
		Switch $nmsg
			...
			Case $pr9
				ShellExecute("http://mysettlers.ru/instrumenty/boty/item/122")
		EndSwitch
	WEnd
...
;массив команд автобота для Юзера
	Switch $delaem
		...
		Case "ЖдемВсехГенералов"
			...
			Return ozidanierasstanovki($generalData[2], $parametr[2])
